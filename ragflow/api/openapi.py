...
PROTECTED_ERROR_RESPONSES: dict[int | str, dict[str, Any]] = {
    ...
    401: _api_error("Bearer authentication failed"),
    ...
    503: _api_error("An authentication or application dependency is unavailable"),
}
...
DOCUMENT_ERROR_RESPONSES: dict[int | str, dict[str, Any]] = {
    **PROTECTED_ERROR_RESPONSES,
    ...
    404: _api_error("The document is not visible to the authenticated user"),
