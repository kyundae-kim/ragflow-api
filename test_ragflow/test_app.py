...
def test_explicit_upload_limit_overrides_runtime_factory_default() -> None:
    @contextmanager
    def runtime_factory() -> Iterator[RuntimeComponents]:
        yield RuntimeComponents(core=object())  # type: ignore[arg-type]
...
def test_openapi_business_operations_use_direct_user_id_contract() -> None:
